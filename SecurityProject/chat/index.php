...
<body>
  <div class="title-chat-c">
    <div class="title-chat">
      ...
      <form href="" method="POST">
        <button type="submit" class="btn btn-outline-danger btn-sm" id="logoutBtn" onmouseover="hover('logout');" onmouseout="out('logout');" name="logout">
  ...
  <!-- Welcome Message -->
  <h1 id="welcome-message" style="text-align: center; font-size:48px;" class="animate__animated animate__fadeIn"><?php echo "<span style='font-weight: 400;'>Welcome, </span><span style='font-weight: 700; text-transform:uppercase;'>".$_SESSION['username']; ?></p>&nbsp<i style="font-size:16px;" class='fas fa-circle align-middle text-success'></i></h1>

  <div class="modal fade fast" id="chatModal" tabindex="-1" aria-labelledby="chatModalLabel" aria-hidden="true">
    <div id="media-chat" class="modal-dialog modal-dialog-scrollable">
      <div id="media-chat-content" class="modal-content">
        <div id="media-chat-header" class="modal-header">
        ...
        <div id="media-chat-box-container" class="mb-3">
              <!-- <label for="chat-box" class="col-form-label">Chat:</label> -->
              <!-- <input type="text" class="form-control disabled" id="chat-box"> -->
              <div id="media-chat-box" id="chat-box" style="height:500px; background-color:#efefef; border:1px solid #ddd; overflow: auto; padding:16px; margin: 25px 15px 0px 15px; border-radius:8px;">
                <!-- <div style="width:100px; height:100px; background-color:red;">SCROLL TEST</div> -->
              </div>
        </div>
        <div id="media-chat-body" class="modal-body">
          <form href="" method="POST">
            <div class="mb-3">
            ...
            <div id="media-chat-footer" class="modal-footer">
